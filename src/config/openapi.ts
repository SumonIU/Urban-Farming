...
const errorResponse = (status: string, message: string) => ({
  description: status,
  content: {
    "application/json": {
...
export const openApiDocument = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Express.js + Prisma backend for urban farming, rentals, produce, forum, plant tracking, and sustainability verification.",
  },
      ...
      get: {
        ...
        responses: {
          200: successResponse(
            "Vendors fetched",
            { type: "object" },
            { vendors: [{ id: "vendor_1", farmName: "Green Plot 1" }] },
          ),
        },
      },
    },
      ...
      patch: {
        ...
        responses: {
          200: successResponse(
            "Vendor approved",
            { type: "object" },
            { vendor: { id: "vendor_1", isApproved: true } },
          ),
          401: errorResponse("Unauthorized", "Authentication required"),
      ...
      patch: {
        ...
        responses: {
          200: successResponse(
            ...
            { type: "object" },
            { cert: { id: "cert_1", status: "VERIFIED" } },
          ),
        },
      },
    },
      ...
      get: {
        ...
        responses: {
          200: successResponse(
            "Produce fetched",
            { type: "object" },
            { items: [{ id: "produce_1", name: "Tomatoes" }] },
          ),
        },
      },
      post: {
        ...
        responses: {
          201: successResponse(
            "Produce created",
            { type: "object" },
            { produce: { id: "produce_1", name: "Tomatoes" } },
          ),
        },
      },
    },
      ...
      get: {
        ...
        responses: {
          200: successResponse(
            ...
            { type: "object" },
            { items: [{ id: "space_1", location: "Zone 1" }] },
          ),
        },
      },
      post: {
        ...
        responses: {
          201: successResponse(
            "Rental space created",
            { type: "object" },
            { rentalSpace: { id: "space_1", location: "Zone 1" } },
          ),
        },
      },
    },
      ...
      get: {
        ...
        responses: {
          200: successResponse(
            "Plants fetched",
            { type: "object" },
            { plants: [{ id: "plant_1", plantName: "Tomato Patch" }] },
          ),
        },
      },
      post: {
        ...
        responses: {
          201: successResponse(
            "Plant tracked",
            { type: "object" },
            { plant: { id: "plant_1", plantName: "Tomato Patch" } },
          ),
        },
      },
    },
